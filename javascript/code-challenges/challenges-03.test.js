...
const containsAnd = (arr) => arr.filter(n => n.includes('and'));
// Solution code here...
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter(n => (!forbiddenValues.includes(n)));
// Solution code here...
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here... Solved in class 04 code review
  return arr.filter((v) => {
