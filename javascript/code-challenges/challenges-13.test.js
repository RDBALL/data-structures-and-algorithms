...
const longestString = (arr) => {
  // Solution code here...
  return arr.findIndex(longString => Math.max(...arr.map(longString => longString.length)) === longString.length);
};
...
const firstLetters = (arr) => {
  // Solution code here...
  return arr.map(firstLetterString => firstLetterString.split('')[0]);
};
