...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach(thirdPower => newArray.push(Math.pow(thirdPower, 3)));
  return newArray;
};
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
  let newArray = [];
  for (let secondPower of arr){
    newArray.push(Math.pow(2, secondPower));
  }
  return newArray;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach(secondPower => newArray.push(Math.pow(2, secondPower)));
  return newArray;
};
